...
public class MecanumDrive {
    ...
    private final DownsampledWriter estimatedPoseWriter = new DownsampledWriter("ESTIMATED_POSE", 8_000_000);
    private final DownsampledWriter targetPoseWriter = new DownsampledWriter("TARGET_POSE", 8_000_000);
    private final DownsampledWriter driveCommandWriter = new DownsampledWriter("DRIVE_COMMAND", 8_000_000);
    private final DownsampledWriter mecanumCommandWriter = new DownsampledWriter("MECANUM_COMMAND", 8_000_000);
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NotNull TelemetryPacket p) {
            ...
            if (t >= (timeTrajectory.duration)) { // CURSED HACK THAT FIXED EVERYTHING
